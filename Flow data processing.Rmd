---
title: "Flow data processing"
author: "Miranda Lentz and Evan Freel"
date: March 26, 2023
...
dependencies <- c("tidyverse","mosaic","openintro","ggformula","infer","gridExtra","cowplot","ggpubr","here","mgcv","Cairo","viridis","readr")
...
Flow.bar.2019.Tukey <- ggplot(Flow2019, aes(x = Species, y = Mass.PerInc08, color = fct_relevel(Flow, "0 tph", "4 tph", "30 tph", "105 tph","210 tph"))) +
  ...
  scale_color_viridis(discrete = TRUE, option = "D", direction = -1) +
  scale_fill_viridis(discrete = TRUE) + 
  annotate("text", x = 1.97, y = 19, label = "a", hjust = 0) + 
  annotate("text", x = 2.12, y = 17.3, label = "b", hjust = 0) + 
  annotate("text", x = 2.25, y = 12, label = "ab", hjust = 0)
Flow.bar.2019.Tukey
```
...
Full.Colony.line <- grid.arrange(MC.Col.stdev, PA.Col.stdev, PM.Col.stdev, ncol=1)
Full.Colony.line
```
